...
This notebook informs the script `action_hot100_current.R` which runs each week based on a Github Action.
...
## This was a one-time write to 02-combine-charts scripts
# charts_archive |> write_csv("data-scraped/hot-100/previous_archive.csv")
```
