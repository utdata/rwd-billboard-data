...
> This supercedes `01-scrape-billboard200` and `01-scrape-hot100` and a bunch of stuff related to them, which I will remove at some point once this logic is reliable.
...
```{r charts-list}
# If you add to this list, you need to add a corresponding folder at `data-scraped`.
