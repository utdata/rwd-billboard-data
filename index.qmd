...
The code that maintains these files is in the [rwd-billboard-data](https://github.com/utdata/rwd-billboard-data) Github repo.
...
There are some Quarto notebooks used to explore and maintain those scripts: `01-scrape-charts.qmd`, `02-combine-charts.qmd` and `03-check-charts.qmd`. There are some details recorded there that can help explain what is happening in the scrap/combine charts scripts.
...
TLDR: My data matches what is currently online (or what was online when I checked it. It's all behind a paywall now).
...
> **September 2026**: Scraper updated after Billboard added a "WEEKS AT NO. 1" to the top row of all their charts. I also converted to Quarto from RNotebooks.
