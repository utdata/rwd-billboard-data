...
The code maintaning the files are in the [rwd-billboard-data](https://github.com/utdata/rwd-billboard-data) Github repo. This site explains exploratory code to figure it out.
...
> **September 2026**: Scraper updated after Billboard added a "WEEKS AT NO. 1" value to all their charts. Also converted to Quarto vs RNotebooks.
