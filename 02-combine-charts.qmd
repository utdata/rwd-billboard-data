...
To combine scraped Billboard chart files with a previous-processed archive to create a "current" archive. See [01-scrape-charts.qmd](01-scrape-charts.qmd) for more info on scraping, and the [home page](index.qmd) for more about the archives.
